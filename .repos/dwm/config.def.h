...
static const char *scratchpadcmd[] = { "alacritty", "-t", scratchpadname, "--config-file", "/home/cole/.config/alacritty/scratchpad.toml", NULL};
...
/*	{ MODKEY|ShiftMask,             XK_0,      tag,            {.ui = ~0 } }, */
    ...
    { MODKEY|ShiftMask,             XK_b,     spawn,    SHCMD("exec $HOME/.scripts/boilerkey") },
    { MODKEY,                       XK_x,     spawn,    SHCMD("exec $HOME/.scripts/k") },
    // { MODKEY,                       XK_m,     spawn,    SHCMD("exec xmouseless") },
    { MODKEY|ShiftMask,             XK_m,     spawn,    SHCMD("exec xmouseless") },
    { MODKEY,                       XK_c,     spawn,    SHCMD("exec $HOME/.scripts/run-vimclip") },
