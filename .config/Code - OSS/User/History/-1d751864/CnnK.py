...
def determine_optimal_card(request):
    if request.method == 'GET':
        ...
        return Response({'card_name': card_info[0][0], 'cashback_percent': card_info[0][1], 'cashback_category': card_info[0][2], 'merchant_name': card_info[1]}, status=status.HTTP_200_OK)