...
def final_determine_card(input_data):
    mcc, mcc_desc, merchant, nfc = get_mcc(input_data["merchant"])
    ...
    # users_cards.pop()
    users_cards = input_data["users_cards"]

    # print("USERS CARDS: ", users_cards)
    return determine_card(users_cards, mcc_desc), merchant