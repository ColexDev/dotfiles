...
def determine_card(users_cards, mcc_desc):
    ...
    for mcc in mcc_desc:
        try:
            out = determine_card_for_category(users_cards, category_values[mcc])
            if (out[1] == 0):
    ...
    return best_card[0], best_card_values[best_card[0]], category_strings[best_card_category[best_card[0]]]
