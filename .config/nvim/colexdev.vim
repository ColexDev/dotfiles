...
let s:cdFront = {'gui': '#ffffff', 'cterm': s:cterm05, 'cterm256': '15'}
let s:cdBack = {'gui': '#000000', 'cterm': s:cterm00, 'cterm256': '0'}

let s:cdTabCurrent = {'gui': '#1E1E1E', 'cterm': s:cterm00, 'cterm256': '234'}
let s:cdTabOther = {'gui': '#202020', 'cterm': s:cterm01, 'cterm256': '236'}
...
let s:cdYellow = {'gui': '#ffff00', 'cterm': s:cterm0A, 'cterm256': '187'}
if g:codedark_conservative | let s:cdYellow = s:cdFront | endif
let s:cdPink = {'gui': '#ff0086', 'cterm': s:cterm0E, 'cterm256': '176'}
...
call <sid>hi('Conditional', s:cdViolet, {}, 'none', {})
...
call <sid>hi('Todo', s:cdFront, s:cdRed, 'none', {})
...
" Constant
call <sid>hi('TSConstant', s:cdOrange, {}, 'none', {})
...
call <sid>hi('TSNamespace', s:cdViolet, {}, 'none', {})
" Functions
call <sid>hi('TSFuncBuiltin', s:cdBlue, {}, 'none', {})
call <sid>hi('TSFunction', s:cdBlue, {}, 'none', {})
call <sid>hi('TSFuncMacro', s:cdBlue, {}, 'none', {})
call <sid>hi('TSParameter', s:cdFront, {}, 'none', {})
call <sid>hi('TSParameterReference', s:cdFront, {}, 'none', {})
call <sid>hi('TSMethod', s:cdBlue, {}, 'none', {})
call <sid>hi('TSField', s:cdFront, {}, 'none', {})
...
call <sid>hi('TSVariableBuiltin', s:cdFront, {}, 'none', {})
" Text
